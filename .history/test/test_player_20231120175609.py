...
for group in groups:
    ...
    # Find the span with the country ID and get the associated text
    country_span = soup.find('span', {'id': group.split('_')[-1]})
    country_name = country_span.text if country_span else ''
