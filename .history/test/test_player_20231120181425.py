...
for group in groups:
    ...
    country_heading = soup.find('span', {'id': group.split('_')[-1]}).find_parent('h3')
    country = country_heading.find('span', class_='mw-headline').text.strip() if country_heading else "Country name not found."
    ...
    if table:
        ...
        for row in table.find_all('tr')[1:]:
            ...
            print(f"Number: {number}, Position: {position}, Player Name: {player_name}, Age: {age}, Club: {club}, Group: {group.split('_')[-1]}, Country: {country}")
