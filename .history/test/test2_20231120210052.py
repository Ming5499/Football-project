...
for table in tables:
    ...
    group_identifier = group_identifier_mapping.get(group_name, "Unknown Group")  # Mapping group names to identifiers
    ...
    for row in rows[1:]:
        ...
        player_count += 1  # Increment player count for each valid player
