...
locations = ['African','Asia','European','North American','Oceanian','South American']
data = []
...
def extract_wikipedia_data(location):
...
fifa = [extract_wikipedia_data(location) for location in locations]
