...
for group in groups:
    ...
    if table:
        country_element = soup.find('span', {'id': group.split('_')[-1]})  # Locate the country element
        country_name = country_element.text if country_element else ''  # Extract country name
        ...
        for row in table.find_all('tr')[1:]:
            ...
            # Print the extracted data along with the group and country name
